...
import 'package:huungry/features/onboarding/views/onboarding_view.dart';
...
class _SplashViewState extends State<SplashView>
  ...
  Future<void> _checkLogin() async {
    ...
    // TODO: Add logic to check if user has seen onboarding before using SharedPreferences
    if (!mounted) return;
    ...
    // Original login check - will be used after onboarding
    // try {
    //   final user = await authRepo.autoLogin();
    //   if (!mounted) return;
    //   if (authRepo.isGuest) {
